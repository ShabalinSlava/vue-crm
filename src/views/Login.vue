...
<form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
        ...
        <div class="input-field">
            ...
            <small class="helper-text invalid" v-if='$v.email.$dirty && !$v.email.required'>{{'Message_EmailValid'|localize}}</small>
        ...
        <div class="input-field">
            ...
            <small class="helper-text invalid" v-else-if='$v.password.$dirty && !$v.password.minLength'>{{'Message_MinLength'|localize}} {{$v.password.$params.minLength.min}} символов. Сейчас он {{password.length}}</small>
        </div>
    </div>
